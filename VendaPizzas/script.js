...
let valorTotal = 0;
let totalpizzas = 0;
const valorPizza = 65.99;

let btnVendas = document.getElementById('vendas');
let btnEstorno = document.getElementById('estornos');
...
function venda(e) {
    if (document.getElementById('mussarela').checked) {
        ...
        vendaMussarela = vendaMussarela + valorPizza;
        ...
        vendaMista = vendaMista + valorPizza;
        ...
        vendaCalabresa = vendaCalabresa + valorPizza;
    ...
    totalpizzas = somaCalabresa + somaMista + somaMussarela;
    valorTotal = vendaCalabresa + vendaMista + vendaMussarela;
    document.getElementById('totalPizzas').innerHTML = totalpizzas
